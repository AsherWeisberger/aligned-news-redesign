/* an140: EN / ES / PT / JA / ZH — chrome dict + full story translation */
(function () {
  var KEY = "an-lang";
  ...
  window.anTxReady = fetch("tx.json?v=an140").then(function (r) {
